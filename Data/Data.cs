        ...
        private static void InitData()
        {
            var series = new Series[]
            {
                new Series()
                {
                    ...
                    DescriptionHtml = "<p>The Amazing Spider-Man (abbreviated as ASM) is an American comic book series published by Marvel Comics, featuring the adventures of the fictional superhero Spider-Man. Being the mainstream coninuity of the franchise, it began publication in 1963 as a monthly periodical and was published continuously, with a brief interruption in 1995, until its relaunch with a new numbering order in 1999. In 2003 the series reverted to the numbering order of the first volume. The title has occasionally been published biweekly, and was published three times a month from 2008 to 2010. A film named after the comic was released July 3, 2012.</p>"
                },
                new Series()
                {
                    Id = 2,
            ...
            var comicBooks = new ComicBook[]
            {
                ...
                new ComicBook()
                {
                    ...
                    Artists = new Artist[]
                   {
                        ...
                        new Artist() {Name="Joe Carmagna", Role="Letters"}
                   },
                    Favorite = false
                },
                new ComicBook()
                {
                    ...
                    Series = series[1],
                    IssueNumber = 50,
                    DescriptionHtml = "<p><strong>The Dungeon & The Parapet, Part 1.</strong> Thorn is discovered by Lord Tarsil and the corrupted Stickeaters and thrown into a dungeon with Fone Bone. As she sleeps, a message comes to her abotu the mysterious \"Crown of Horns\".</p>",
                    Artists = new Artist[]
                   {
